...
from models.efects import Efects
...
class Game:
    ...
    def handle_victory(self):
        self.efects.print_success("Parabéns! Você ganhou a batalha!\n")
        self.death_nv(1)
            ...
            while True:
                try:
                    ...
                    if equip_choice == "s":
                        ...
                        self.efects.print_success("Arma equipada!\n")
                        break
                    elif equip_choice == "n":
                        self.efects.print_warning("Arma jogada no lixo..\n")
                        break 
                    else:
        ...
        while True:
            try:
                ...
                if save_choice == "s":
                    ...
                    self.efects.print_warning("Jogo salvo com sucesso!\n")
                    break 
        ...
        while self.hero.health > 0 and self.enemy.health > 0:
            ...
            try:
                ...
                if choice == 1:
                    ...
                    self.efects.print_error("Ação inválida.")
            except ValueError:
                self.efects.print_error("Ação inválida. Turno perdido.")
    ...
    def start_battle(self):
        while True:
            ...
            fala = "Iniciando batalha contra" + self.enemy.name + "!"
            self.efects.print_battle(fala)
            time.sleep(1)
            ...
            if self.hero.health > 0 and self.enemy.health <= 0:
                ...
                self.efects.print_error("Você foi derrotado! Fim de jogo.")
